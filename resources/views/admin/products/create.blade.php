<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form id="createProductForm" action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" placeholder="Product Price" name="price" class="input input-bordered w-full  " />
                        <input type="text" placeholder="Product Stock" name="stock" class="input input-bordered w-full mt-6" />
                        <div class="mt-6">
    ...
    <script>
        var checkList = document.getElementById('categoriesList');
